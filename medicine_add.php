...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `medicine` (`National Drug Code`, `Medicine Name`, `Expiry Date`, Manufacturer, Form, Frequency, `Precaution and Warning`) VALUES ('$ndc','$medicine_name','$expiry_date','$manufacturer','$form','$frequency','$precaution_and_warning')";
...
<body>
    <div class="container">
        <form method="post">
            ...
            <div class="form-group">
                <label for="address">Precaution and Warning</label>
